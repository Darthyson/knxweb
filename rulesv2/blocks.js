...
/*
 * editTextArea function qui permet d'ouvrir une "boite de dialogue" permettant le choix dans un slider
 *
 *  
 */
function editTextArea_object(block, text)
{
  TextAreaBlock_ = block;
  var select_objects_list = document.getElementById('objects_list');
  if (TextAreaBlock_.idObject_) select_objects_list.value = TextAreaBlock_.getText(); //idObject_; //getValue();
  else if (TextAreaBlock_.text_) select_objects_list.value = TextAreaBlock_.text_;
  affiche_object();
};
function editTextArea_script(block, text)
{
  TextAreaBlock_ = block;
  var textarea_script = document.getElementById('textarea_script');
  if (TextAreaBlock_.sourceBlock_.script_) textarea_script.value = TextAreaBlock_.sourceBlock_.script_;
  affiche_script();
};
Blockly.Blocks['list_objects'] = {
  init: function() {
    ...
    this.appendDummyInput()
        .appendField("object : ")
        //.appendField(new Blockly.FieldTextAreaInput(" -:| Click to choose an Object |:- ", editTextArea_object), "object");
        .appendField(new Blockly.FieldTextAreaInput(" -:| Click to choose an Object |:- "), "object");
    this.setOutput(true, "object");
    this.setTooltip('List of Objects');
  }
};
...
Blockly.Blocks['value'] = {
  init: function() {
    ...
    */
    ...
    this.setTooltip('string value (on, off, 0, 1 ...)');
  }
};
...
Blockly.Blocks['timer_type'] = {
  init: function() {
    ...
    this.setColour(65);
    this.appendDummyInput()
        .appendField(new Blockly.FieldDropdown([["sunrise", "sunrise"], ["sunset", "sunset"], ["noon", "noon"]]), "timer_type")
        .appendField("offset")
...
Blockly.Blocks['default_rule'] = {
  init: function() {
    ...
    this.appendStatementInput("actionslist_true")
        ...
        .appendField(new Blockly.FieldDropdown([["if-true", "if-true"], ["on-true", "on-true"]], function(updatedText) { /* TODO changer automatiquement le "false" aussi */ return updatedText; }), "true_type");
    this.appendStatementInput("actionslist_false")
        .setCheck("action")
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField(new Blockly.FieldDropdown([["if-false", "if-false"], ["on-false", "on-false"]], function(updatedText) { /* TODO changer automatiquement le "true" aussi */ return updatedText; }), "false_type");
    this.setTooltip('A rule');
...
Blockly.JavaScript['default_rule'] = function(block) {
  ...
  var statements_actionslist_true = Blockly.JavaScript.statementToCode(block, 'actionslist_true');
  var dropdown_true_type = block.getFieldValue('true_type');
  var statements_actionslist_false = Blockly.JavaScript.statementToCode(block, 'actionslist_false');
  var dropdown_false_type = block.getFieldValue('false_type');

  //var code = '<rule id="ID_rule" description="Description" init="false" >\n';
  var code = '<rule id="' + document.getElementsByName("id_rule")[0].value + '" description="' + document.getElementsByName("description")[0].value + '" init="'+document.getElementsByName("init")[0].checked+'" >\n';
...
Blockly.Blocks['condition_AND_OR'] = {
  ...
  init: function() {
    ...
    this.appendValueInput('ADD0')
        .appendField(new Blockly.FieldDropdown([["ET", "and"], ["OU", "or"]]), "type")
        .setCheck('condition');
    ...
    this.setTooltip('Condition OR or AND');
    this.itemCount_ = 2;
  },
  ...
  domToMutation: function(container) {
    ...
    for (var x = 0; x < this.itemCount_; x++) {
      ...
      if (x == 0) {
        ...
        input.appendField(new Blockly.FieldDropdown([["ET", "and"], ["OU", "or"]]), "type");
      }
    }
...
Blockly.Blocks['condition_object'] = {
  init: function() {
    ...
    this.appendDummyInput("id")
        //.appendField("object : ")
        .appendField(new Blockly.FieldTextAreaInput(" -:| Click to choose an Object |:- "), "id")
        .appendField(" ");
...
*/
  ...
  // TODO : si "value" est de type "object" alors c'est une condition de type : object-compare
...
Blockly.Blocks['condition_time-counter'] = {
  init: function() {
    ...
    this.setColour(210);
    this.appendDummyInput()
        .appendField("Time Counter : threshold")
        .appendField(new Blockly.FieldTextInput(""), "threshold")
        .appendField("reset-delay")
          ...
          if (option == 'at') {
            ...
            if (!at_exceptionExists) {
              block.appendDummyInput("at_exception")
                   ...
                   .appendField(new Blockly.FieldDropdown([["Not Use", ""], ["TRUE", "TRUE"], ["FALSE", "FALSE"]]), "at_exception");
...
Blockly.Blocks['action_set_object'] = {
  init: function() {
    ...
    this.appendDummyInput()
        .appendField("Set")
        .appendField(new Blockly.FieldTextAreaInput(" -:| Click to choose an Object |:- "), "from")
        .appendField("to")
        .appendField(new Blockly.FieldTextAreaInput(" -:| Click to choose an Object |:- "), "to")
        .appendField("(delay")
        .appendField(new Blockly.FieldTextInput(""), "delay")
        .appendField(")");
...
Blockly.Blocks['action_send-read-request'] = {
  init: function() {
    ...
    this.setColour(160);
    this.appendDummyInput()
        .appendField("Send Read Request to")
        .appendField(new Blockly.FieldTextAreaInput(" -:| Click to choose an Object |:- "), "id")
        .appendField("(delay")
        .appendField(new Blockly.FieldTextInput(""), "delay")
        .appendField(")");
...
Blockly.Blocks['action_formula'] = {
  init: function() {
    ...
    this.setColour(160);
    this.appendDummyInput()
        .appendField("Formula (id=a*x^m+b*y^n+c)")
        .appendField("(delay")
        .appendField(new Blockly.FieldTextInput(""), "delay")
        .appendField(")");
    this.appendDummyInput()
    ...
    this.appendDummyInput()
        .appendField("x")
        .appendField(new Blockly.FieldTextAreaInput(" -:| Click to choose an Object |:- "), "x");
    this.appendDummyInput()
        .appendField("y")
        .appendField(new Blockly.FieldTextAreaInput(" -:| Click to choose an Object |:- "), "y");
...
Blockly.Blocks['action_Cancel'] = {
  init: function() {
    ...
    this.appendDummyInput("rule_id")
        .appendField("Cancel rule")
        //.appendField(new Blockly.FieldDropdown(list_rules), "rule_id")
        .appendField(new Blockly.FieldTextAreaInput(" -:| Click to choose a Rule |:- ", 'select_list_rules'), "rule_id")
        .appendField("(delay")
        .appendField(new Blockly.FieldTextInput(""), "delay")
        .appendField(")");
...
Blockly.Blocks['condition_ioport-rx'] = {
  ...
  init: function() {
    ...
    this.appendDummyInput()
        .appendField("Io-Port :")
        //.appendField(new Blockly.FieldDropdown(list_ioports), "ioport") // TODO gérer la list des ioports
...
Blockly.JavaScript['action_ioport-tx'] = function(block) {
  ...
  */
  var code = '<action type="ioport-tx" ioport="' + value_ioport + '" data="' + value_data + '" hex="' + checkbox_hex + '" delay="' + value_delay + '" ></action>\n'; 
  return code;
};
